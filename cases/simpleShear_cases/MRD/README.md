...
./Allrun
```
* After running move to the *PostProcessData* folder and run the *runBatch* script, which is created as symbolik link to *...simpleShear_cases/pythonScriptToPlotData_simpleShear/runBatch_simpleShear* script:
```
./runBatch
```
